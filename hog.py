...
def is_swap(score0, score1):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    while score0!=0 and score0!= 1 and score1 !=0 and score1 != 1:
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal :
        if player == 0:
            player0_turn = take_turn(strategy0(score0, score1),score1, dice)
            score0 += player0_turn
        else:
            player1_turn = take_turn(strategy1(score1, score0),score0, dice)
            score1 += player1_turn
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    # BEGIN PROBLEM 7
    def say(score0, score1, who = who , past_high = previous_high , past_score = previous_score):
        if who == 0:
            new_high = score0 - past_score
        else :
            new_high = score1 - past_score
        if new_high > past_high:
            past_high = new_high
            if new_high == 1:
                print("1 point! That's the biggest gain yet for Player",who)
            else:
                print(new_high, "points! That's the biggest gain yet for Player",who)
        return announce_highest(who, past_high, past_score + new_high)
    return say
...
def bacon_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    if n > 10:
        ...
        n=n//10
        second_digit = n%10
        abs_diff= abs(first_digit - second_digit) + 2
    else :
        abs_diff = n + 2
    if abs_diff >= margin:
        return 0
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    if n > 10:
        ...
        n=n//10
        second_digit = n%10
        bacon_tester = abs(first_digit - second_digit) + 2
    else :
        bacon_tester = n + 2
    if score != 0 and opponent_score > score and opponent_score % score == 0 :
        swap_tester = True
    else :
        swap_tester =  False
    if bacon_tester >= margin or swap_tester == True :
        return 0
    else :
        return num_rolls
